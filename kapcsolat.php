...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1 container kapcsolat-style">
            <h1 class="row text-decoration-underline">A weboldalról:</h1>
            <p class="col-12">
            ...
            <h2 class="row text-decoration-underline">Regisztráció, bejelentkezés</h2>
            <p class="col-12">
            ...
            <h2 class="row text-decoration-underline">Állatok megtekintése</h2>
            <p> 
            ...
            <h2 class="row text-decoration-underline">Állat feltöltése</h2>
            <p>
            ...
            <h2 class="row text-decoration-underline">Kapcsolat és támogatás</h2>
            <p>
