...
<body class="d-flex flex-column min-vh-100">
    <header>
        ...
        <main class="flex-grow-1 container fotozastippek-style">
            <h1 class="row text-decoration-underline">Fotózási tippek</h1>
            <p class="col-12">
            ...
            <h2 class="row text-decoration-underline">Háttér:</h2>
            <p class="col-12">
            ...
            <h2 class="row text-decoration-underline">Kompozíció:</h2>
            <p class="col-12">
            ...
            <h2 class="row text-decoration-underline">Időzítés:</h2>
            <p class="col-12">
